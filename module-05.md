...
## Daftar Isi
  ...
  - [2. Atribut dan Method dalam Kelas](#2-atribut-dan-method-dalam-kelas)
    - [A. Konvensi Penamaan Method](#a-konvensi-penamaan-method)
    - [B. Konvensi Penamaan Atribut](#b-konvensi-penamaan-atribut)
    - [C. Tipe Kembalian (Return Type)](#c-tipe-kembalian-return-type)
    - [D. Visibilitas](#d-visibilitas)
    - [E. Classifiers](#e-classifiers)
    - [F. Constructor](#f-constructor)
    - [G. Konvensi Penamaan Konstanta](#g-konvensi-penamaan-konstanta)
  - [3. Relasi antar Kelas](#3-relasi-antar-kelas)
    - [A. Relasi Dua Arah](#a-relasi-dua-arah)
  - [4. Kardinalitas pada Relasi](#4-kardinalitas-pada-relasi)
  - [5. Anotasi pada Kelas](#5-anotasi-pada-kelas)
